...
urlpatterns = [
    ...
    path("collections/<int:pk>/edit/", web_views.collection_edit_view, name="collection_edit"),
    path("collections/<int:pk>/add-model/", web_views.collection_add_model_view, name="collection_add_model"),
