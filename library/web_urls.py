...
urlpatterns = [
    ...
    path("settings/extension/download/", web_views.extension_download_view, name="extension_download"),
    ...
    path("settings/bambu-cloud/logout/", web_views.bambu_cloud_logout_view, name="bambu_cloud_logout"),
    path("settings/mmf/oauth/start/", web_views.mmf_oauth_start_view, name="mmf_oauth_start"),
    path("settings/mmf/oauth/callback", web_views.mmf_oauth_callback_view),
    path("settings/mmf/oauth/callback/", web_views.mmf_oauth_callback_view, name="mmf_oauth_callback"),
    path("settings/mmf/oauth/complete/", web_views.mmf_oauth_complete_view, name="mmf_oauth_complete"),
    path("settings/mmf/oauth/logout/", web_views.mmf_oauth_logout_view, name="mmf_oauth_logout"),
